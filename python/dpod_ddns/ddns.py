...
class DDNS:
	def __init__(self,Id,Token):
		...
		self.format="json"
		self.lang="cn"
		self.headers={"User-Agent":"ddns_for_raspberry_pi/0.1(zy84338719@hotmail.com)"}
	...
	def get_new_ip(self):
		result=os.popen(
			"/sbin/ifconfig -a|grep inet|grep -v 127.0.0.1|grep -v inet6|awk '{print $2}'|tr -d \"addr:\" | grep 192.168")
		context = result.read()
